...
public sealed class StraightChargeExecutor
{
    ...
    // 実行設定
    private StraightChargeSettings m_settings;
    ...
    /// 直線突進を開始します。
    /// </summary>
    /// <param name="settings">突進設定。</param>
    ...
    /// </returns>
    public bool Start(
        StraightChargeSettings settings,
    ...
    {
        if (m_settings.AttackIdentifier == null)
        {
            return;
        }
